...
class Login extends Component {
  ...
  render() {
    const { email, password, signInButtonText, isSignInButtonDisabled } = this.state;
    return (
      <Container fluid>
        <Row className="pt-5">
          <Col
          ...
          > 
            ...
            <Container className="my-5 py-5 px-4 border border-secondary rounded">
              ...
              <Form className="form" onSubmit={this.signIn}>
                ...
                <Button className="w-100" disabled={isSignInButtonDisabled}>
                  {signInButtonText}
                </Button>
              </Form>
            </Container>
            <Container className="mt-5 py-3 text-center border border-secondary rounded">
              New to Mine?
              <Link to="/signup">
                <Button color="link" className="py-0 px-1 border-0">
                  Create an account
                </Button>
              </Link>
            </Container>
