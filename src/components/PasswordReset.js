...
class PasswordReset extends Component {
  constructor(props) {
    ...
    this.state = {
      email: "",
      emailLabelText: "Enter your email address and we will send you a link to reset your password",
  ...
  submit = (event) => {
    ...
    if (email === CORRECT_EMAIL) {
      this.setState({
        emailLabelText: "Check your email for a link to reset your password",
      ...
      <Container fluid>
        ...
        <Row className="pt-1">
          ...
          >
            <Container className="my-5 py-5 px-4 border border-secondary rounded">
              <Form className="form" onSubmit={this.submit}>
                ...
                {shouldShowSubmitButton ? (
                  ...
                  <Button type="button" className="w-100" onClick={this.goBack}>
                    Return to sign in
                  </Button>
                )}
            ...
            <Alert color="danger" className="w-100 position-relative" isOpen={this.state.isAlertVisible} toggle={this.onDismiss}>
